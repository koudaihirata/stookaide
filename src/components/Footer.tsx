...
export default function Footer() {
    return(
        <>
            <footer className={css({width:{base:'100%', lg:'390px'},height:'120px',position:'fixed',bottom:'-10px',left:{base:'0', lg:'50%'},transform:{base:'none', lg:'translateX(-50%)'}})}>
                <div className={css({width:'85%',margin:'0 auto',display:'flex',alignItems:'center',justifyContent:'space-around'})}>
                    ...
                    <Link href="/Photograph">
                        <div className={css({width:'80px',height:'80px',borderRadius:'50%',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column',bg:'linear-gradient(180deg, #FFCE7B 0%, #FAA755 100%)',transform:'translateY(-10px)'})}>
